...
<div class="container">
  <div class="pt-5">
    <div class="d-flex mt-5 flex-column gap-4 align-items-center justify-content-center">
      <img class="img-fluid w-25" src="{{ asset('vector/deactive-pharmacy.svg') }}">
      <p class="text-primary-darker fs-5">حسابك غير مفعل عزيزي الصيدلي
        يمكنك التأكد من البريد الإلكتروني أو التواصل معنا..</p>
    </div>
  </div>
</div>
