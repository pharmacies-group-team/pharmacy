...
<body style="font-family: 'Tajawal', sans-serif;">
  <div
    style=" width: 100%; display: flex; justify-content: center; align-items: center; margin-top: 30px;height: 300px; background-image: url('https://i.ibb.co/Bzv2hnJ/message.png'); background-repeat: no-repeat; background-position: left; background-size: 30%">
    <div>
      ...
      <a style="background: #3869BA; padding: 10px 20px; border-radius: 8px; color: #fff2f2; text-decoration: none"
        href="{{ $url }}">اضغط هنا لتفعيل حسابك</a>
