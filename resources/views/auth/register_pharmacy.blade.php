      ...
      <div class="row">
        <div class="col-lg-7 col-md-6 col-12 ">
          <div class="p-5">
            ...
            <p class="fs-6 text-primary-darker mt-5">صيدلية أونلاين توفر للعميل إمكانية طلب كافة احتياجاته من الصيدلية سواء أدوية أو منتجات غير دوائية أونلاين ليتم تحضير الطلب ثم توصيله بعد ذلك إلى عنوان العميل.</p>
            <p class="fs-6 text-primary-darker mt-3">الآن مع صيدلية أون لاين يمكنك زيادة عدد عملاء صيدليتك وبالتالى زيادة مبيعاتك ،فقط قم بتسجيل صيدليتك معنا واجعل طلب الأدوية والمنتجات غير الدوائية من صيدليتك اونلاين</p>
          </div>
        </div>
