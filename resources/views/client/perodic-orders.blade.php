            ...
            @foreach ($perodic_orders as $perodic_order)
              <tr>
                ...
                <td>
                  ...
                  <form method="post" action='{{ route('client.togglePerodicOrder', ['id' => $perodic_order->id]) }}'>
                    @csrf
                    <button type="submit" class="btn {{ $perodic_order->is_active ? 'btn-danger' : 'btn-primary' }} m-1">
