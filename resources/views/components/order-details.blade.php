        ...
        <x-modal open="orderModal" :title="__('heading.order-details')">
            <div class="t-order-details">
                ...
                <div class="t-order-details-user">
                    {{-- avatar --}}
                    <div>
                        <img src="{{ asset(\App\Enum\UserEnum::USER_AVATAR_PATH . $order->user->avatar) }}"
                ...
                <div class="t-order-details-description">
                    ...
                    @if ($order->image !== '0')
                        <div x-data="{ isZoom: false }">
                            ...
                            <img src="{{ asset('uploads/order/' . $order->image) }}" alt="order-image"
                                class="t-order-image" @click="isZoom = true" @click.away="isZoom = false">
