      ...
      <form method="post" action="{{ route('admin.updateSocial') }}">
        ...
        <div class="form-group">
          ...
          <input class="form-control @error('facebook') is-invalid @enderror" name="facebook"
            value="@if(isset($social->facebook)) {{ $social->facebook }} @endif" type="url" id="mainTitle" placeholder="ادخل حساب الفيسبوك " />
        ...
        <div class="form-group">
          ...
          <input type="url" name="twitter" class="form-control @error('twitter') is-invalid @enderror"
            value="@if(isset($social->twitter)) {{ $social->twitter }} @endif" id="inputLastName" placeholder="ادخل حساب التويتر" />
          @error('twitter')
            <span class="error invalid-feedback">{{ $message }}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <input class="form-control @error('whatsapp') is-invalid @enderror" name="whatsapp"
            value="@if(isset($social->whatsapp)) {{ $social->whatsapp }} @endif" type="url" id="mainTitle" placeholder="ادخل حساب الواتس اب " />
          @error('whatsapp')
            <span class="error invalid-feedback">{{ $message }}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <input type="url" name="instagram" class="form-control @error('instagram') is-invalid @enderror"
            value="@if(isset($social->instagram)) {{ $social->instagram }} @endif" id="inputLastName" placeholder="ادخل حساب الانستقرام" />
          @error('instagram')
            <span class="error invalid-feedback">{{ $message }}</span>
          @enderror
        </div>
