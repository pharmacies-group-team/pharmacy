        ...
        <div class="container-fluid p-0">
            <div class="d-flex justify-content-between my-2 ">
                ...
                <button type="button" class="btn btn-primary  mt-n1 block " data-bs-toggle="modal" data-bs-target="#add">
                    <i class="fas fa-plus"></i>اضافه اعلان
                </button>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($ads as $ad)
                                                    <tr class="odd">
                                                        {{-- {{ dd($ad) }} --}}
                                                        <td>
                                                            <img :src="'{{ url('img/ads') }}/{{ $ad->icon }}'"
                                                                {{-- alt="{{ $ad->image }}" src="{{ $ad->image }}" --}} name="image"
                                                                        ...
                                                                        <form method="post" class="needs-validation"
                                                                            ...
                                                                            <div class="mb-3">
                                                                                <label class="form-label"
                                                                                    for="ad-name-label">أسم
                                                                                    الأعلان</label>
                                                                                <input id="ad-name-label" name="title"
                                                                                    :value="ad.title" type="text"
                                                                            ...
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <input type="text"
                                                                                    ...
                                                                                    placeholder="حدد تاريخ البدأ"
                                                                                    readonly="readonly" name="start_at"
                                                                                    :value="ad.start_at">
                                                                                @error('start_at')
                                                                                    <span id="exampleInputEmail1-error"
                                                                                        class="error invalid-feedback">{{ $message }}</span>
