...
<header id="header" class="header top-header bg-blur">
  <div class="top-left">
    <div class="navbar-header">
      ...
      <a class="navbar-brand hidden" href="{{ route('home') }}"><img src="{{ asset('images/logo.svg') }}" alt="Logo"></a>
...
{{--        </div>--}}
      ...
      <div class="user-area dropdown float-right">
        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <img class="user-avatar rounded-circle" src="@if (Auth::user()->avatar) {{ asset(UserEnum::USER_AVATAR_PATH.Auth::user()->avatar) }} @else {{ asset(UserEnum::USER_AVATAR_DEFAULT) }} @endif" alt="User Avatar">
        </a>

        <div class="user-menu dropdown-menu">
          <a class="dropdown-item text-primary-dark d-flex align-items-center"
             href="
                 @if(Auth::user()->hasRole(\App\Enum\RoleEnum::PHARMACY))
          ...
          <a class="dropdown-item text-primary-dark d-flex align-items-center"
             href="
                 ...
                 @endif
               ">
            <i class="bi bi-speedometer m-2 text-primary-light"></i> إعدادات الحساب
          </a>
          <a class="dropdown-item text-primary-dark d-flex align-items-center"
