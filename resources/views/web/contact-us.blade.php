...
@section('content')
  ...
  <main class="page-contact-us container">
    <div class="t-item">
      <div class="t-content">
        <h3 class="t-title">تواصل معنا</h3>

        <p class="text-body-color mb-9 text-base leading-relaxed">
          منصة صيدليه اون لين
          هدفنا تسهيل عملية شراء الدواء كما نسعى الى توفير الأدوية النادرة لطالبيها و تعريف الصيدلية الأدوية التي يجب
          توفيرها وتوفير أدوية بشكل دوري لأصحاب الأمراض المزمنة
        </p>
      </div>
    </div>
    <div class="t-item t-form-wrapper">
      <form class="t-form">
        <div>
        ...
        <div>
          <button type="submit" class="t-btn btn-full">
            @lang('action.send')
          </button>
        </div>
      </form>
