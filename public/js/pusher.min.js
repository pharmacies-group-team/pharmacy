              ...
              switch (typeof o) {
                case "object":
                  ...
                  if (
                    ...
                    for (c = [], i = 0; i < o.length; i += 1)
                      c[i] = t(o[i], r + "[" + i + "]");
                  else
                    for (s in ((c = {}), o))
                      Object.prototype.hasOwnProperty.call(o, s) &&
                        (c[s] = t(o[s], r + "[" + JSON.stringify(s) + "]"));
                  return c;
                case "number":
                case "string":
                case "boolean":
          ...
          return (
            (t.prototype.send = function (t) {
              ...
              o.insertBefore(e.script, o.firstChild),
                e.errorScript &&
                  o.insertBefore(e.errorScript, e.script.nextSibling);
            }),
        ...
        pt = (function (t) {
          ...
          return (
            ...
            (e.prototype.connect = function () {
              ...
              return (
                this.bindListeners(),
                $.debug("Connecting", { transport: this.name, url: e }),
      ...
      var kt = bt,
              ...
              var i = this.transport.createConnection(t, e, n, o),
                ...
                a = function (t) {
                  if (
                    ...
                    e < 2 * r.maxPingDelay &&
                      (r.manager.reportDeath(),
                      (r.pingDelay = Math.max(e / 2, r.minPingDelay)));
                  }
                };
          ...
          return (
            (t.prototype.send = function (t, e) {
              this.timeline.isEmpty() ||
                this.timeline.send(_e.TimelineTransport.getAgent(this, t), e);
            }),
            t
          );
        })(),
                      ...
                      ? ((t.subscriptionPending = !1),
                        ...
                        t.emit(
                          ...
                          Object.assign(
                            ...
                            e instanceof w ? { status: e.status } : {}
                          )
                        ))
        ...
        Mt = (function (t) {
          ...
          return (
            Nt(e, t),
            (e.prototype.authorize = function (t, e) {
              return Qt.createAuthorizer(this, this.pusher.config).authorize(
                t,
                e
              );
            }),
                          ...
                          void this.authorize(
                            ...
                            function (e, s) {
                              e
                                ...
                                : null !==
                                  (i = n.nacl.secretbox.open(o, r, n.key))
            ...
            return (
              r.bind("online", function () {
                o.timeline.info({ netinfo: "online" }),
                  ("connecting" !== o.state && "unavailable" !== o.state) ||
                    o.retryIn(0);
              }),
                ...
                e = function (n, o) {
                  n
                    ...
                    ? (t.emit("error", {
                      ...
                      t.timeline.error({ handshakeError: o.error }))
          ...
          (t.prototype.connect = function (t, e) {
            ...
            if (o && o.timestamp + this.ttl >= M.now()) {
              ...
              i &&
                ...
                r.push(
                  new Yt([i], { timeout: 2 * o.latency + 1e3, failFast: !0 })
                ));
            }
            var s = M.now(),
      ...
      var se,
        ce = function (t, e, n) {
          ...
          var i,
            ...
            C = new Yt(
              [new oe(ie(S), new $t([S, new ne(k, { delay: 4e3 })]), k)],
              u
            ),
            T = new oe(ie(C), C, _);
          return (
        ...
        ge = (function () {
          ...
          return (
            ...
            (t.prototype.onChunk = function (t) {
              ...
              if (200 === t.status)
                switch (
                  (this.readyState === pe.OPEN && this.onActivity(),
                  t.data.slice(0, 1))
                ) {
                  case "o":
            ...
            (t.prototype.openStream = function () {
              ...
              (this.stream = _e.createSocketRequest(
                "POST",
                fe(this.hooks.getReceiveURL(this.location, this.session))
              )),
          ...
          return (
            (t.prototype.log = function (t, e) {
              t <= this.options.level &&
                (this.events.push(H({}, e, { timestamp: M.now() })),
                this.options.limit &&
      ...
      var De = (function () {
          function t(e, n) {
            ...
            if (
              ...
              $.warn(
                "You should always specify a cluster when connecting. " + c
              );
            }
            "disableStats" in n &&
              $.warn(
              ...
              (this.config =
                ((r = {
                  ...
                  unavailableTimeout:
                    o.unavailableTimeout || s.unavailableTimeout,
                ...
                "disabledTransports" in o &&
                  (r.disabledTransports = o.disabledTransports),
